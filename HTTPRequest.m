...
/**
 ...
 @example
    ...
    [HTTPRequest get:@"http://soyoes.com/seal/api/orders" handler:handler datas:nil];
...
+ (void)get:(NSString *)url handler:(HTTPRequestHandler)handler datas:(NSDictionary*)datas{
    ...
    if(datas)req.datas = [[NSMutableDictionary alloc] initWithDictionary:datas];
    req.handler = handler;
